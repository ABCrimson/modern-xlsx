# Ironsheet Phase 1 Design: Core Read/Write MVP
...
├── crates/
│   ├── ironsheet-core/           # Pure Rust: data models, XML, ZIP
│   └── ironsheet-wasm/           # WASM bindings via wasm-bindgen
├── packages/
│   └── ironsheet/                # Main npm package (TS + WASM)
├── benchmarks/
└── docs/
```
