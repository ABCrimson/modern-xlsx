...
impl ContentTypes {
    ...
    pub fn to_xml(&self) -> Result<String> {
        ...
        for (part, ctype) in &self.overrides {
            ...
            writer
                .write_event(Event::Empty(elem))
                .map_err(|e| IronsheetError::XmlWrite(format!("writing Override: {e}")))?;
        }

        // </Types>
        writer
            .write_event(Event::End(quick_xml::events::BytesEnd::new("Types")))
            .map_err(|e| IronsheetError::XmlWrite(format!("writing Types end: {e}")))?;
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Override PartName="/xl/worksheets/sheet1.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"/>
    ...
    fn test_write_content_types() {
        ...
        let ct2 = ContentTypes::parse(xml.as_bytes()).unwrap();
