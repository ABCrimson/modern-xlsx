...
impl Relationships {
    ...
    pub fn to_xml(&self) -> Result<String> {
        ...
        writer
            ...
            .map_err(|e| IronsheetError::XmlWrite(format!("writing XML decl: {e}")))?;
        ...
        writer
            ...
            .map_err(|e| IronsheetError::XmlWrite(format!("writing Relationships start: {e}")))?;
        ...
        for rel in &self.relationships {
            ...
            writer
                ...
                .map_err(|e| IronsheetError::XmlWrite(format!("writing Relationship: {e}")))?;
        }
        ...
        writer
            ...
            .map_err(|e| {
                IronsheetError::XmlWrite(format!("writing Relationships end: {e}"))
            })?;
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  ...
  <Relationship Id="rId3" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/>
    ...
    fn test_write_relationships() {
        ...
        let rels2 = Relationships::parse(xml.as_bytes()).unwrap();
